...
CGameInput::CGameInput()
{
	...
	m_Key[_GI_K_OEM_MINUS] = VK_OEM_MINUS; //键盘键-
...
bool CGameInput::GetKeyDown(unsigned char Key)
{
	return m_KeyState[Key] == _KS_DC || m_KeyState[Key] == _KS_DH;
	   
}

void CGameInput::SetHWND(HWND h)
{
	m_hWnd = h;
}
